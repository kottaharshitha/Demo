...
st.markdown("<h3 style='color: blue,font-size: 30px;'>Types of Cats</h3>", unsafe_allow_html=True)
...
with col2:
  st.markdown("<h3 style='color: pink;'>Ragdoll Cat</h3>", unsafe_allow_html=True)
